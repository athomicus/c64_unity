#!/usr/bin/env python3
# konwerter256na32.py — konwertuje obrazek 256x32px do kafla C64 hires
# Uzycie: python3 konwerter256na32.py obrazek.png nazwa_kafla [bg_color_index]
# Wynik:  nazwa_kafla.h z static const unsigned char nazwa_kafla[1152]
#
# Kafel: 256x32px = 32x4 komorek 8x8
# Format: [1024B pikseli][128B kolorow] = 1152B razem
# DRAW_TILE(nazwa, dest_cx, dest_cy, 32, 4, fg, bg);
#
# pip install Pillow
...
PIXEL_BYTES = 1024
COLOR_BYTES = 128
SCRIPT_NAME = "konwerter256na32.py"
