#!/usr/bin/env python3
# konwerter256na16.py — konwertuje obrazek 256x16px do kafla C64 hires
# Uzycie: python3 konwerter256na16.py obrazek.png nazwa_kafla [bg_color_index]
# Wynik:  nazwa_kafla.h z static const unsigned char nazwa_kafla[576]
#
# Kafel: 256x16px = 32x2 komorek 8x8
# Format: [512B pikseli][64B kolorow] = 576B razem
# DRAW_TILE(nazwa, dest_cx, dest_cy, 32, 2, fg, bg);
#
# pip install Pillow
...
PIXEL_BYTES = 512
COLOR_BYTES = 64
SCRIPT_NAME = "konwerter256na16.py"
