#!/usr/bin/env python3
# konwerter128na16.py — konwertuje obrazek 128x16px do kafla C64 hires
# Uzycie: python3 konwerter128na16.py obrazek.png nazwa_kafla [bg_color_index]
# Wynik:  nazwa_kafla.h z static const unsigned char nazwa_kafla[288]
#
# Kafel: 128x16px = 16x2 komorek 8x8
# Format: [256B pikseli][32B kolorow] = 288B razem
# DRAW_TILE(nazwa, dest_cx, dest_cy, 16, 2, fg, bg);
#
# pip install Pillow
...
PIXEL_BYTES = 256
COLOR_BYTES = 32
SCRIPT_NAME = "konwerter128na16.py"
