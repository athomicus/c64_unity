#!/usr/bin/env python3
# konwerter128na32.py — konwertuje obrazek 128x32px do kafla C64 hires
# Uzycie: python3 konwerter128na32.py obrazek.png nazwa_kafla [bg_color_index]
# Wynik:  nazwa_kafla.h z static const unsigned char nazwa_kafla[576]
#
# Kafel: 128x32px = 16x4 komorek 8x8
# Format: [512B pikseli][64B kolorow] = 576B razem
# DRAW_TILE(nazwa, dest_cx, dest_cy, 16, 4, fg, bg);
#
# pip install Pillow
...
PIXEL_BYTES = 512
COLOR_BYTES = 64
SCRIPT_NAME = "konwerter128na32.py"
