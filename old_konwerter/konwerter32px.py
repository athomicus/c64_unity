...
# Uzycie: python3 konwerter32px.py obrazek.png nazwa_kafla
...
# DRAW_TILE(nazwa, dest_cx, dest_cy, 4, 4);
#
# pip install Pillow
...
def convert(input_path, tile_name):
    ...
    with open(out_path, "w") as f:
        ...
        f.write(f"/* Uzycie: DRAW_TILE({tile_name}, dest_cx, dest_cy, 4, 4); */\n\n")
        f.write(f"static const unsigned char {tile_name}[144] = {{\n")
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print(f"Uzycie: python3 konwerter32px.py obrazek.png nazwa_kafla")
        print(f"Przyklad: python3 konwerter32px.py grass.png grass")
        print(f"Wynik:    grass.h  z  DRAW_TILE(grass, x, y, 4, 4);")
        sys.exit(1)
